...
- If analyze_clip's visualDescription mentions on-screen text, UI labels, code, captions, signs, or "screen recording" — prefer generate_image for the matched b-roll too.
